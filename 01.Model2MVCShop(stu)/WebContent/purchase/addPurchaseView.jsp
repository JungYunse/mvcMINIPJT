...
<!DOCTYPE html>
<%
// Product prod = (Product)request.getAttribute("PurchaseProd");
// System.out.println("product에서뽑아보기 = "+ prod);

// Purchase purchase = new Purchase();
// request.setAttribute("purchase",purchase);

// session.getAttribute("user");
// System.out.println("user 에서 가져온거 보기 : "+ session.getAttribute("user"));
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">구매상세정보</td>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">
			구매자아이디 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle" name ="userId"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><input type="hidden" name ="userId" value="${user.userId }" >${user.userId }</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
...
<%-- 		%>  --%>
<!--  				<option value="0" selected>현금결제</option> -->
<!-- 				<option value="1">카드결제</option> -->
			
<%-- 		<%  --%>
<!-- //  				}else if(purchase.getPaymentOption().equals("1")){ -->
<%--  		%> --%>
<%--  		<%} %>  --%>
...
<%-- 	<%	}%>  --%>
	...
	<tr>
		...
		<td aligh="right">
			<select name="paymentOption" class="ct_input_g" style="width:80px">
			<option value="현금" ${!empty purchase.paymentOption!= null && purchase.paymentOption == "현금" ? "selected" : ""  }>현금 </option>
			<option value="카드" ${!empty purchase.paymentOption!= null && purchase.paymentOption == "카드" ? "selected" : ""  }>카드 </option>
		</select>
		</td>
	</tr>
